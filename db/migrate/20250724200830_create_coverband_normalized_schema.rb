...
class CreateCoverbandNormalizedSchema < ActiveRecord::Migration[6.1]
  def change
    ...
    create_table :coverband_test_cases do |t|
    ...
    create_table :coverband_requests do |t|
    ...
    create_table :coverband_files do |t|
    ...
    create_table :coverband_methods do |t|
    ...
    create_table :coverband_test_coverage do |t|
